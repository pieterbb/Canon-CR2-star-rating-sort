...
#TODO: Figure something out so it works in Windows and OSX while staying in the same file. With the filepaths and escaped backslashes

# pyinstaller --onefile main_windows.py --icon=camera.ico
...
Canon CR2 RatingSort: Sort photo's in folder by rated and unrated V.01
    ...
    exit_message = input("Done! Press enter to exit")
